...
这一章将快速回顾前深度学习时代的NLP。我们会看到两次重要的范式转变：从符号主义到统计方法，以及统计方法如何在"特征工程的诅咒"中逐渐走向瓶颈。在深入解决方案之前，下一章将先鸟瞰NLP的核心任务全景——理解这个领域"做什么"，才能更好地理解后续技术"为什么这样演进"。
...
这个问题的答案，将在第3章给出：表示学习，从Word2Vec开始的"词向量"革命。但在此之前，下一章将先退后一步，鸟瞰NLP领域的核心任务全景——理解"做什么"，才能更好地理解"怎么做"。
...
这正是表示学习要解决的核心问题——第3章将从Word2Vec开启词向量革命。但在此之前，下一章将先给你一张NLP核心任务的全景地图，让你知道这个领域到底在解决哪些问题。

> 下一章预告：第2章将鸟瞰NLP的核心任务全景——从文本分类到机器翻译，从信息抽取到问答系统，理解"NLP做什么"才能更好地理解后续章节的"为什么"。
