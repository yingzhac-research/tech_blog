...
Welcome! This is a minimal post to confirm that listings, styling, and
navigation work as expected.

Some inline code like \texttt{print("hello")} should be easy to read in
dark mode.
...
\BuiltInTok{print}\NormalTok{(greet(}\StringTok{"Quarto"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
