# TODO: NLP textbook audit plan (ch16-ch23)
...
- Structure: follow the 0-7 section spine; pain-point-driven opening; clear bridge from prior chapter.
- Researcher orientation: include boundary conditions, failure modes/limitations, and open questions.
- Writing style: intuition before formulas; prose-first; use analogies and multi-angle explanations.
...
- Asset hygiene: paper-sourced figures saved under posts_ch/nlp/figures/chapter-XX/original; filenames traceable.
- Technical standards: YAML front matter completeness; inline-math conflicts with |<> avoided; image paths are relative and renderable.

## Inputs to collect
- Extract the required items from the skills above into a single audit checklist.
- From nlp-textbook-outline.md, confirm ch16-ch23 placement and cross-chapter dependencies.
...
- Inventory all figures and algorithm/pseudocode callouts in ch16-ch23.
...
- Check figure storage paths under posts_ch/nlp/figures/chapter-16..23/original and note missing folders/files.
...
- Identify repeated explanations across ch16-ch23 (e.g., scaling vs emergence vs ICL vs instruction tuning).
